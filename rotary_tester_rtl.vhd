...
BEGIN
  ...
  BEGIN
    ...
    report "Wrong values of P and/or DIR for test 1";
    -- test 2
    wait for period;
    A <= '1';
    B <= '1'; -- P = 1, DIR = 1
    assert (P = '1' and DIR = '1');
    report "Wrong values of P and/or DIR for test 2";
    -- test 3
    wait for period;
    A <= '0';
    B <= '1'; -- P = 1, DIR = 0
    assert (P = '1' and DIR = '0');
    report "Wrong values of P and/or DIR for test 3";
    -- test 4
    wait for period;
    A <= '1';
    B <= '0'; -- P = 1, DIR = 1
    assert (P = '1' and DIR = '1');
    report "Wrong values of P and/or DIR for test 4";
  END PROCESS;
END rtl;
